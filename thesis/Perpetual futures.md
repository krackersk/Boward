...
## Competition
[SymmIO](https://www.symm.io/) - intent based backend OTC aggregator which protocols such as [basedmarkets](https://twitter.com/basedmarkets) (Base L2), [IntentX](https://twitter.com/IntentX_) (Base L2), and [Thena](https://twitter.com/ThenaFi_) (BNB chain) have built 3rd party frontends for. Not sure if it runs on a chain or is totally off-chain, can't find info in any of the docs.
